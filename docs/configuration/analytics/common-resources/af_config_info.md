...
<b>URL:</b>https://&lt;MGMT-IP&gt;/nitro/v1/config/af_config_info/propkey_value&lt;String&gt;
...
<b>URL:</b>https://&lt;MGMT-IP&gt;/nitro/v1/config/af_config_info
<b>HTTP Method:</b>null
<b>Response Payload: </b>```{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "af_config_info":[{"propkey":<String_value>,"propvalue":<String_value>}]}```
