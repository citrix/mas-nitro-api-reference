...
Configuration for AF HTTP Method table resource.
...
<b>URL: </b>https://&lt;MGMT-IP&gt;/nitro/v1/config/http_req_method

<b>HTTP Method: </b>null

<b>Response Payload: </b>
```
{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "http_req_method":[{
