#tcp_interface_stacked

Configuration for AF TCP Interface Stacked Area Reports resource.
...
<b>URL:</b>https://&lt;MGMT-IP&gt;/nitro/v1/config/tcp_interface_stacked
<b>HTTP Method:</b>null
<b>Response Payload: </b>```{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "tcp_interface_stacked":[{"data_volume":<Double_value>,"timestamp":<Double_value>,"__count":<Double_value>,"throughput":<Double_value>,"id":<String_value>,"vlan":<String_value>}]}```
