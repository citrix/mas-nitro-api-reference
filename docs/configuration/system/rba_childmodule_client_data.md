#rba_childmodule_client_data



Configuration for RBA Child Module Client Data resource.
...
<b>URL:</b>https://&lt;MGMT-IP&gt;/nitro/v1/config/rba_childmodule_client_data

<b>HTTP Method:</b>null

<b>Response Payload: </b>
```
{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "rba_childmodule_client_data":[{
