#event_nssdx_device_report

Configuration for Event Mgmt Device Instability Report for NSSDX resource.
...
<b>URL:</b>https://&lt;MGMT-IP&gt;/nitro/v1/config/event_nssdx_device_report
<b>HTTP Method:</b>null
<b>Response Payload: </b>```{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "event_nssdx_device_report":[{"ip_address":<String_value>,"severity":<String_value>,"total_count":<Integer_value>,"hostname":<String_value>}]}```
