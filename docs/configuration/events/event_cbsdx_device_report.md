#event_cbsdx_device_report



Configuration for Event Mgmt Device Instability Report for CBSDX resource.
...
<b>URL: </b>https://&lt;MGMT-IP&gt;/nitro/v1/config/event_cbsdx_device_report

<b>HTTP Method: </b>null

<b>Response Payload: </b>
```
{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "event_cbsdx_device_report":[{
