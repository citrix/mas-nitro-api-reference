#event_cb_device_report



Configuration for Event Mgmt Device Instability Reportfor Cloud Bridge Devices resource.
...
<b>URL: </b>https://&lt;MGMT-IP&gt;/nitro/v1/config/event_cb_device_report

<b>HTTP Method: </b>null

<b>Response Payload: </b>
```
{ "errorcode": 0, "message": "Done", "severity": ;ltString_value>, "event_cb_device_report":[{
